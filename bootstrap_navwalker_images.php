...
class fullbase_wp_bootstrap_navwalker extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		$output .= "\n$indent<ul role=\"menu\" class=\" dropdown-menu\"> <div class=\" yamm-content\">\n";
	}
